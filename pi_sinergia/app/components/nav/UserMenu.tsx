...
const UserMenu:React.FC<UserMenuProps> = ({currentUser}) => {
    ...
    <>
        <div className="relative z-30">
            <div onClick={toggleOpen} className="p-2 border-[1px] border-slate-400 flex flex-row items-center gap-1 rounded-full 
            ...
            { isOpen && (
                ...
                text-sm flex flex-col cursor-pointer"> 
                    {currentUser ? <div>
                        ...
                        <Link href="/admin">
                            <MenuItem onClick={toggleOpen}>Admin Dashboards</MenuItem>
                        </Link>
                        <hr/>
                        <MenuItem onClick={() => {
                            toggleOpen();
                        ...
                        <Link href="/register">
                            <MenuItem onClick={toggleOpen}>Registre-se</MenuItem>
                        </Link>
                    </div> }
